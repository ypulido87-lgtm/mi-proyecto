...
Domain: https://rosamariabello.com/
Project: rosamariabello.com
Stack: Unknown
Site Type: Unknown
Date: 2026-08-24T15:37:46+00:00
...
AEO Technical Score: 84/100  
  applicable 9 | passed 7 | warnings 1 | failed 1 | N/A 0 | manual review 1

## Executive Summary

The audit ran 34 checks: 11 PASS, 6 WARNING, 1 FAIL, 13 N/A, 3 MANUAL REVIEW.

Findings by priority: P0 0, P1 2, P2 6, P3 2.
...
- **Entity clarity** (WARNING, AEO): Multiple Organization entities are declared and 4 carry no @id, so the publishing entity is ambiguous
- **Structured data** (FAIL, AEO): 1 served structured claims are unsupported by visible text
...
- **Markdown negotiation** (WARNING, Content Accessibility): HTML returned for Accept: text/markdown (text/html)
...
| Sitemap | PASS | Agent Readiness | live | Sitemap valid, referenced from robots.txt, 21 URLs, sample all 2xx |
...
| Check | Status | Score set | Evidence | Detail |
|---|---|---|---|---|
| Markdown negotiation | WARNING | Agent Readiness | live | HTML returned for Accept: text/markdown (text/html) |
| Server-rendered content | PASS | AEO Technical | live | Homepage delivers 4297 characters of text without JavaScript |
...
| Check | Status | Score set | Evidence | Detail |
|---|---|---|---|---|
| Crawlability | PASS | AEO Technical | live | Commercial SEO crawlers are disallowed (AhrefsBot, SemrushBot, DotBot, MJ12bot, BLEXBot). Search engines and AI agents are unaffected |
| Content availability | PASS | AEO Technical | live | Served homepage carries 684 words of extractable text |
| Entity clarity | WARNING | AEO Technical | live | Multiple Organization entities are declared and 4 carry no @id, so the publishing entity is ambiguous |
| Structured data | FAIL | AEO Technical | live | 1 served structured claims are unsupported by visible text |
...
| Canonicalization | PASS | AEO Technical | live | Canonical declared: https://rosamariabello.com |
...
- Live origin inspection of https://rosamariabello.com/ (TLS verification DISABLED)
...
| AEO Technical Score | 84/100 | 84/100 |
