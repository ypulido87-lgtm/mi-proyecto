...
Domain: https://culturaminiteka.com/
Project: culturaminiteka.com
Stack: Unknown
Site Type: Unknown
Date: 2026-08-24T15:36:50+00:00
...
Agent Readiness Score: 79/100  
  applicable 10 | passed 4 | warnings 6 | failed 0 | N/A 12 | manual review 2

AEO Technical Score: 91/100  
  applicable 9 | passed 8 | warnings 0 | failed 1 | N/A 0 | manual review 1

## Executive Summary

The audit ran 34 checks: 12 PASS, 6 WARNING, 1 FAIL, 12 N/A, 3 MANUAL REVIEW.

Findings by priority: P0 0, P1 1, P2 7, P3 2.
...
- **Semantic HTML** (FAIL, Content Accessibility): Served homepage: No h1 heading in the served HTML
...
| Sitemap | PASS | Agent Readiness | live | Sitemap valid, referenced from robots.txt, 968 URLs, sample all 2xx |
...
| Server-rendered content | PASS | AEO Technical | live | Homepage delivers 7174 characters of text without JavaScript |
| Semantic HTML | FAIL | AEO Technical | live | Served homepage: No h1 heading in the served HTML |
...
| Content availability | PASS | AEO Technical | live | Served homepage carries 1336 words of extractable text |
| Entity clarity | PASS | AEO Technical | live | Homepage entities: Organization, WebSite |
...
| Canonicalization | PASS | AEO Technical | live | Canonical declared: https://culturaminiteka.com |
...
- Live origin inspection of https://culturaminiteka.com/ (TLS verification DISABLED)

## Before / After

| Item | Before | After |
|---|---|---|
| Agent Readiness Score | 79/100 | 79/100 |
| AEO Technical Score | 91/100 | 91/100 |
